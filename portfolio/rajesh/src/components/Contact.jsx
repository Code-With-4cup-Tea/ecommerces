...
const Contact = () => {
  return (
   <>
      <div id='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4
       text-white'>
         <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
             ...
             <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/933be36b-02a2-4090-a400-5933baf3d57f" 
                  method='POST' className='flex flex-col w-full md:w-1/2'>
                     ...
                     border-2 rounded-md text-white focus:outline-none'/>
                     <textarea name="message" rows="10" placeholder='Enter your massege' 
